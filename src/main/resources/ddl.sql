...
INSERT INTO restaurante (id, nome, taxa_frete, cozinha_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_cidade_id, data_cadastro, data_atualizacao) VALUES (1, 'Thai Gourmet', 10, 1, 'Bairro de Uberlandia', '12345-123','','Rua do Bairro', 123, 1, utc_timestamp, utc_timestamp)
INSERT INTO restaurante (id, nome, taxa_frete, cozinha_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_cidade_id, data_cadastro, data_atualizacao) VALUES (2, 'Thai Delivery', 9.50, 1, 'Bairro de SP', '12345-123','','Rua do Bairro', 123, 3, utc_timestamp, utc_timestamp)
INSERT INTO restaurante (id, nome, taxa_frete, cozinha_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_cidade_id, data_cadastro, data_atualizacao) VALUES (3, 'Tuk Tuk Comida Indiana', 15, 2, 'Bairro de SP', '12345-123','','Rua do Bairro', 123, 3, utc_timestamp, utc_timestamp)
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_cidade_id, data_cadastro, data_atualizacao) values (4, 'Java Steakhouse', 12, 3, 'Bairro de Fortaleza', '12345-123','','Rua do Bairro', 123, 5, utc_timestamp, utc_timestamp)
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_cidade_id, data_cadastro, data_atualizacao) values (5, 'Lanchonete do Tio Sam', 11, 4, 'Bairro de Fortaleza', '12345-123','','Rua do Bairro', 123, 5, utc_timestamp, utc_timestamp)
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_bairro, endereco_cep, endereco_complemento, endereco_logradouro, endereco_numero, endereco_cidade_id, data_cadastro, data_atualizacao) values (6, 'Bar da Maria', 6, 4, 'Bairro de Fortaleza', '12345-123','','Rua do Bairro', 123, 5, utc_timestamp, utc_timestamp)
